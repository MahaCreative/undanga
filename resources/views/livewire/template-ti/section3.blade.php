<section id="slide2" class="relative min-h-[700px] md:min-h-screen md:max-h-[100%] bg-secondary overflow-hidden py-16">     
    ...
    <div class="flex justify-center md:gap-y-0 lg:gap-x-14">
        <div loading="lazy"
        data-aos="zoom-in"  
        data-aos-delay="1500"
        data-aos-duration="1000"
        ...
        class="col-span-12 md:col-span-6 text-center flex flex-col items-center justify-center gap-y-3">
            ...
            <h3 class="text-white font-bold text-2xl font-mono">Resepsi Pernikahan</h3>
            <p class="w-64 text-white">Hotel Berkah</p>
    ...
    data-aos="zoom-in"  
        ...
        data-aos-easing="linear"
    class="mt-6">
        <button class="bg-white py-1.5 px-3  outline-dashed outline-white outline-offset-4 rounded-lg shadow-md shadow-white hover:scale-110 hover:bg-opacity-75 hover:backdrop-blur-md duration-300 ease-in-out transition">Lihat Peta</button>
    </div>
    <img loading="lazy"
    data-aos="zoom-in"  
        data-aos-delay="1000"
