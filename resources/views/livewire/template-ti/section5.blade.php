<section id="slide2" class="relative min-h-[700px] md:min-h-screen md:max-h-[100%] bg-secondary overflow-hidden py-16">     
    ...
    <div class="grid grid-cols-12 gap-y-6 z-50 relative">
        <div
        data-aos="zoom-in"  
        data-aos-delay="200"
        ...
        data-aos-easing="ease-out-cubic"
        class="col-span-12 md:col-span-6 flex justify-center">
            <img loading="lazy" class="w-[250px]" src="{{asset('gambar/protocol-03.png')}}" alt="">
        </div>
        <div
        data-aos="zoom-in"  
        data-aos-delay="1400"
        ...
        data-aos-easing="ease-out-cubic"
        class="col-span-12 md:col-span-6 flex justify-center">
            <img loading="lazy" class="w-[250px]" src="{{asset('gambar/protocol-04.png')}}" alt="">
        </div>
        <div
        data-aos="zoom-in"  
        data-aos-delay="1800"
        data-aos-duration="1000"
        data-aos-easing="ease-out-cubic"
        class="col-span-12 md:col-span-12 flex justify-center ">
            <img loading="lazy" class="w-[250px]" src="{{asset('gambar/protocol-05.png')}}" alt="">
        </div>
