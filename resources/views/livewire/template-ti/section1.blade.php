    ...
    <div class="w-full  absolute top-0 left-0 z-10">
        <div class="w-full h-screen relative flex justify-center items-center bg-segitiga bg-opacity-60  bg-no-repeat bg-center bg-[length:90%_60%] md:bg-[length:60%_70%] pb-10">
            <div class="absolute text-center mb-16">
                ...
                <p class="text-yellow-400 font-cairo font-medium my-1 text-sm md:text-lg lg:text-xl italic">Minggu, 26 November 2022</p>
                <div class="flex items-center justify-center gap-x-1 md:gap-x-3">
                    <p class="text-white font-cairo font-light text-sm lg:text-[24pt]">
                        <span  id="hari"></span><span class="text-[10pt] md:text-[12pt] font-cairo font-extralight">Hari</span>
                    </p>
                    <p class="text-white font-cairo font-light text-sm lg:text-[24pt]">
                        <span  id="jam"></span><span class="text-[10pt] md:text-[12pt] font-cairo font-extralight">Jam</span>
                    </p>
                    <p class="text-white font-cairo font-light text-sm lg:text-[24pt]">
                        <span  id="menit"></span><span class="text-[10pt] md:text-[12pt] font-cairo font-extralight">Menit</span>
                    </p>
                    <p class="text-white font-cairo font-light text-sm lg:text-[24pt]">
                        <span  id="seconds"></span><span class="text-[10pt] md:text-[12pt] font-cairo font-extralight">Detik</span>
                    </p>
