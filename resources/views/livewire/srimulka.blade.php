<div class="min-w-full overflow-x-hidden">
    <div id="modal-frame"
        class="hidden w-full h-screen justify-center bg-black backdrop-blur-sm items-center z-50 fixed top-0 left-0">
        <div id="modal"
            class="relative w-[85%] md:w-1/2 rounded-lg shadow-md bg-primary items-center flex flex-col justify-center py-4 px-8">
